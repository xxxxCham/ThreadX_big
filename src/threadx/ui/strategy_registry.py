...
# =============================================================================
# STRATÉGIE SCALPING 2025 - EMA + STOCHASTIC SCALPING (1-MINUTE)
# =============================================================================

REGISTRY["EMAStochScalpStrategy"] = {
    "indicators": {
        "ema": {
            "fast_period": {
                "default": 50,
                ...
                "step": 10,
                "type": "int",
                "label": "Période EMA Rapide",
                "description": "EMA rapide pour tendance (20=très rapide, 80=lent)",
            },
            "slow_period": {
                "default": 100,
                "min": 60,
                ...
                "step": 10,
                "type": "int",
                "label": "Période EMA Lente",
                "description": "EMA lente pour tendance (60=rapide, 150=très lent)",
            },
        },
        "stochastic": {
            "k_period": {
                ...
                "step": 1,
                "type": "int",
                "label": "Période Stochastic %K",
                "description": "Période %K (8=sensible, 21=lent)",
            },
            "d_period": {
                "default": 3,
                "min": 2,
                ...
                "step": 1,
                "type": "int",
                "label": "Période Stochastic %D",
                "description": "Période lissage %D (signal)",
            },
            "smooth": {
                "default": 3,
                "min": 1,
    ...
    "params": {
        ...
        "fast_ema": {
            ...
            "label": "Période EMA Rapide",
            "opt_range": (30, 70),
            "description": "EMA rapide pour détecter tendance (recommandé: 50)",
        },
        "slow_ema": {
            "default": 100,
            "min": 60,
            ...
            "label": "Période EMA Lente",
            "opt_range": (80, 120),
            "description": "EMA lente pour confirmer tendance (recommandé: 100)",
        },
        ...
        "stoch_k": {
            ...
            "label": "Période Stochastic %K",
            "opt_range": (10, 18),
            "description": "Période %K pour oscillateur (8=très sensible, 21=lent)",
        },
        "stoch_d": {
            "default": 3,
            "min": 2,
            ...
            "step": 1,
            "type": "int",
            "label": "Période Stochastic %D (Signal)",
            "opt_range": (2, 4),
            "description": "Période lissage %D (ligne signal)",
        },
        "stoch_smooth": {
            "default": 3,
            "min": 1,
            ...
            "label": "Lissage %K",
            "opt_range": (2, 4),
            "description": "Période lissage supplémentaire %K",
        },
        "stoch_oversold": {
            "default": 20.0,
            "min": 15.0,
            ...
            "step": 5.0,
            "type": "float",
            "label": "Seuil Survente Stochastic",
            "opt_range": (15.0, 25.0),
            "description": "Zone survente (15=très sensible, 30=conservateur)",
        },
        "stoch_overbought": {
            "default": 80.0,
            "min": 70.0,
            ...
            "step": 5.0,
            "type": "float",
            "label": "Seuil Surachat Stochastic",
            "opt_range": (75.0, 85.0),
            "description": "Zone surachat (70=sensible, 85=conservateur)",
        },
        # Entry Filters
        "require_pullback": {
            "default": True,
            "type": "bool",
            "label": "Exiger Pullback vers EMAs",
            "tunable": False,
            "description": "Attendre pullback prix vers EMAs avant entrée",
        },
        "pullback_tolerance_pct": {
            ...
            "step": 0.1,
            "type": "float",
            "label": "Tolérance Pullback (%)",
            "opt_range": (0.2, 0.5),
            "description": "Distance max prix/EMAs pour valider pullback (0.1%=strict, 0.8%=lax)",
        },
        "volume_ma_period": {
            "default": 10,
            "min": 5,
            ...
            "step": 5,
            "type": "int",
            "label": "Période SMA Volume",
            "opt_range": (5, 15),
            "description": "Période moyenne mobile volume (confirmation)",
        },
        "volume_threshold": {
            "default": 1.2,
            "min": 1.0,
            ...
            "step": 0.1,
            "type": "float",
            "label": "Seuil Volume (× moyenne)",
            "opt_range": (1.1, 1.5),
            "description": "Volume minimum vs SMA (1.0=pas de filtre, 2.0=volume double)",
        },
        # Risk Management
        "stop_loss_pct": {
            "default": 0.5,
            ...
            "step": 0.1,
            "type": "float",
            "label": "Stop Loss % (scalping serré)",
            "opt_range": (0.4, 0.7),
            "description": "Stop loss fixe en % (0.3%=très serré, 1.0%=large)",
        },
        "take_profit_pct": {
            "default": 0.7,
            "min": 0.4,
            ...
            "step": 0.1,
            "type": "float",
            "label": "Take Profit % (scalping)",
            "opt_range": (0.5, 1.0),
            "description": "Take profit fixe en % (0.4%=rapide, 1.5%=long)",
        },
        "risk_per_trade": {
            "default": 0.01,
            "min": 0.005,
            ...
            "step": 0.005,
            "type": "float",
            "label": "Risque par Trade (fraction capital)",
            "opt_range": (0.008, 0.02),
            "description": "Risque max par position (0.5%=conservateur, 3%=agressif)",
        },
        # Position Management
        "leverage": {
            "default": 15.0,
            ...
            "step": 5.0,
            "type": "float",
            "label": "Levier (scalping)",
            "opt_range": (10.0, 20.0),
            "tunable": False,
            "description": "Levier trading (5x=conservateur, 30x=très agressif, recommandé: 10-20x)",
        },
        "max_hold_bars": {
            "default": 30,
            "min": 10,
            ...
            "label": "Durée Max Position (barres)",
            "opt_range": (20, 40),
            "description": "Temps max position (10=rapide, 60=lent) - en minutes si 1m timeframe",
        },
        # Fees
        "fee_bps": {
            "default": 4.5,
            ...
            "label": "Frais (basis points)",
            "tunable": False,
            "description": "Frais trading en bps (4.5 = 0.045%)",
        },
        "slippage_bps": {
            "default": 2.0,
            "min": 0.0,
            ...
            "label": "Slippage (basis points)",
            "tunable": False,
            "description": "Slippage estimé (scalping rapide = slippage élevé)",
        },
    },
}
